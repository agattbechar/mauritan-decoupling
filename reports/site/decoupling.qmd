...
![Structural Overlay (β and ρ)](docs/assets/charts/09_structural_overlay.png)
...
The result table was produced by the analysis pipeline and saved as:
...
|---|---:|---:|---:|---:|---:|
| Amplifier (2022-2023) | **0.121** | **0.738** | (measured in the output) | **0.738** (food persistence) | 24 |
| Absorber (2024-2025) | **-0.022** | **0.399** | (measured in the output) | **0.399** (food persistence) | 24 |
...
But the volatility results show:
...
## 10) Why This Matters: The Cost of Capital

Macro stability is not abstract. It shows up in borrowing costs.

Countries with volatile inflation pay higher interest rates — investors demand a premium for uncertainty. When inflation swings unpredictably, lenders charge more and lend shorter-term.

Your findings suggest a structural reduction in inflation volatility:
- Pass-through collapsed (β → 0)
- Persistence fell sharply (ρ → 0.40)
- Shocks fade faster (half-life dropped)

**What this means:**

If markets recognize this regime change, Mauritania's sovereign borrowing costs should fall. Domestic firms can access cheaper capital. Longer-term investment becomes viable.

This is not about gas revenue itself. It is about whether capital will flow *beyond* the extractive sector — into infrastructure, manufacturing, services — because macro risk has structurally declined.

The decoupling creates preconditions for broad-based investment, not just resource extraction.
